...
BODY {
						...
						<tbody>
							...
							<tr class="xdTableContentRow">
								<td vAlign="top" style="BORDER-TOP: #000000 1pt; BORDER-RIGHT: #bfbfbf 1pt; BORDER-BOTTOM: #bfbfbf 1pt; BORDER-LEFT: #bfbfbf 1pt" class="xdTableContentCell">
									<div align="center"><xsl:apply-templates select="my:groupA1List/my:A1List" mode="_2"/>
										<div class="optionalPlaceholder" xd:xmlToEdit="组2_460" tabIndex="0" xd:action="xCollection::insert" align="left" style="WIDTH: 100%">插入项</div>
									</div>
								</td>
							</tr>
						</tbody>
	...
	<xsl:template match="my:A1List" mode="_2">
		<div title="" class="xdRepeatingSection xdRepeating" style="MARGIN-BOTTOM: 0px; WIDTH: 100%" align="left" xd:CtrlId="CTRL89" xd:xctname="RepeatingSection" tabIndex="-1" xd:widgetIndex="0">
			<div> </div>
			<div><span title="" class="xdTextBox" hideFocus="1" tabIndex="0" xd:binding="my:fieldA1" xd:CtrlId="CTRL90" xd:xctname="PlainText" style="WIDTH: 100%">
